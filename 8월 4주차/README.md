...
**5. 프로그래머스 문제 [12978](https://programmers.co.kr/learn/courses/30/lessons/12978)**
...
사실 dfs로 구현했다가 실패했다ㅠ^ㅠ
답지를 봤는데 너무 어려워서 이해는 천천히 해보려고 하지만 대다수의 사람들이 큐를 사용해서 푸는 것 같다.
구글링 하면 deque를 사용해서 푸는데 나는 priorityqueue를 사용해서 푸는 방법을 참고해서 풀었다.
