...
4. **풍선 터뜨리기 [68646](https://programmers.co.kr/learn/courses/30/lessons/68646)**
...
끝 제외한 가운데 숫자 중에서 끝이 제한의 끝보다 작다면 그 숫자는 마지막까지 남을 수 있다. 따라서 양 끝을 지정한 후 끝보다 가운데의 끝이 작다면 끝이 될 수 있다.
...
5. **JadenCase 문자열 만들기 [12951](https://programmers.co.kr/learn/courses/30/lessons/12951)**
...
공백이 연속으로 있을 수도 있기 때문에 아래와 같이 한번 분기처리 해줘야한다.
...
그 후에 trim() 메소드를 이용해서 제일 끝의 공백 문자를 제거해주었다.
